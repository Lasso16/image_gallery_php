<div id="<?= "category" . $idCategoria?>" class="tab-pane <?= $idCategoria === 1 ? 'active' : '' ?>">
    <div class="row popup-gallery">
                ...
                <?php foreach ($imagenesIndex as $i): ?>
                        ...
                        <div class="behind">
                            <div class="head text-center">
                                <ul class="list-inline">
                                    <li>
                                        <a class="gallery" href="<?= $i->getUrlGaleria() ?>" data-toggle="tooltip" data-original-title="Quick View">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                    </li>
                                    <li>
                            ...
                            <div class="row box-content">
                                <ul class="list-inline text-center">
                                    <li><i class="fa fa-eye"></i><?=$i->getNumVisualizaciones()?></li>
                                    <li><i class="fa fa-heart"></i> <?=$i->getNumLikes()?></li>
                                    <li><i class="fa fa-download"></i> <?=$i->getNumDownloads()?></li>
                                </ul>
                            </div>
                        </div>
            </div>
