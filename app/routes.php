...
$router->get('exposicion/anadirimagen/:idImagen', 'ImagenExposicionController@seleccionar', 'ROLE_USER');
$router->post('exposicion/anadirimagen', 'ImagenExposicionController@guardar','ROLE_USER');
